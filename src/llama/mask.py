...
def estimate_reliability_region_mask(images: np.ndarray, mask_options: MaskOptions, plotting=False):
    ...
    close_structure = xp.array(skimage.morphology.diamond(mask_options.binary_close_coefficient))
    erode_structure = xp.array(skimage.morphology.diamond(mask_options.binary_erode_coefficient))
