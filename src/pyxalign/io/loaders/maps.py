...
def get_loader_options_by_enum(key: ExperimentType) -> OptionsClass:
    return {
        ...
        ExperimentType.BEAMLINE_2IDE_PTYCHO: Microprobe2IDELoadOptions(
            mda_folder=None,
            base=BaseLoadOptions(parent_projections_folder=None),
        ),
        ExperimentType.BEAMLINE_2IDD_PTYCHO: BNP2IDELoadOptions(
            mda_folder=None,
            base=BaseLoadOptions(parent_projections_folder=None),
        ),
...
def get_experiment_type_enum_from_options(options: OptionsClass) -> ExperimentType:
    ...
    elif isinstance(options, BNP2IDELoadOptions):
