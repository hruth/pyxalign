...
from pyxalign.data_structures.projections import ComplexProjections, PhaseProjections, Projections
...
if __name__ == "__main__":
    # from pyxalign.api.options import DownsampleOptions
    # import numpy as np
    ...
    # reload_module_and_imports("pyxalign", globals())
    # print("p is not stale:", isinstance(p, PhaseProjections))
    ...
    from pyxalign.data_structures.projections import PhaseProjections  # this one has to be called after the reload
    from pyxalign.data_structures.task import LaminographyAlignmentTask  # this one has to be called after the reload
    ...
    reload_module_recursively(pyxalign, False)
